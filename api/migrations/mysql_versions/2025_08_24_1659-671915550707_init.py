...
Revision ID: 671915550707
Revises: 
Create Date: 2025-08-24 16:59:21.579709
...
def upgrade():
    ...
    sa.Column('type', sa.String(length=40), server_default=sa.text("'dataset'"), nullable=False),
    ...
    sa.Column('data_source_type', sa.String(length=255), server_default=sa.text("'database'"), nullable=False),
    ...
    sa.Column('tenant_id', models.types.StringUUID(), nullable=False),
    sa.Column('has_permission', sa.Boolean(), server_default=sa.text('1'), nullable=False),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    ...
    sa.Column('built_in_field_enabled', sa.Boolean(), server_default=sa.text('0'), nullable=False),
    ...
    sa.Column('id', models.types.StringUUID(), nullable=False),
    sa.Column('model_name', sa.String(length=255), server_default=sa.text("'text-embedding-ada-002'"), nullable=False),
    sa.Column('hash', sa.String(length=64), nullable=False),
    sa.Column('embedding', sa.LargeBinary(), nullable=False),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    sa.Column('provider_name', sa.String(length=255), server_default=sa.text("''"), nullable=False),
    ...
    sa.Column('is_anonymous', sa.Boolean(), server_default=sa.text('1'), nullable=False),
    ...
    with op.batch_alter_table('external_knowledge_bindings', schema=None) as batch_op:
        ...
        batch_op.create_index('external_knowledge_bindings_external_knowledge_idx', ['external_knowledge_id'], unique=False, mysql_length=255)
    ...
    sa.Column('tenant_id', models.types.StringUUID(), nullable=False),
    sa.Column('provider_name', sa.String(length=255), nullable=False),
    sa.Column('provider_type', sa.String(length=40), server_default=sa.text("'custom'"), nullable=False),
    sa.Column('encrypted_config', sa.Text(), nullable=True),
    sa.Column('is_valid', sa.Boolean(), server_default=sa.text('false'), nullable=False),
    sa.Column('last_used', sa.DateTime(), nullable=True),
    sa.Column('quota_type', sa.String(length=40), server_default=sa.text("''"), nullable=True),
    ...
    sa.Column('chat_color_theme_inverted', sa.Boolean(), server_default=sa.text('0'), nullable=False),
    sa.Column('copyright', sa.String(length=255), nullable=True),
    sa.Column('privacy_policy', sa.String(length=255), nullable=True),
    sa.Column('show_workflow_steps', sa.Boolean(), server_default=sa.text('1'), nullable=False),
    sa.Column('use_icon_as_answer_icon', sa.Boolean(), server_default=sa.text('0'), nullable=False),
    sa.Column('custom_disclaimer', sa.TEXT(), nullable=False),
    ...
    sa.Column('prompt_public', sa.Boolean(), server_default=sa.text('0'), nullable=False),
    ...
    sa.Column('id', models.types.StringUUID(), nullable=False),
    sa.Column('name', sa.String(length=255), server_default=sa.text("'API KEY 1'"), nullable=False),
    ...
    sa.Column('id', models.types.StringUUID(), nullable=False),
    sa.Column('name', sa.String(length=256), server_default=sa.text("'API KEY 1'"), nullable=False),
    sa.Column('tenant_id', models.types.StringUUID(), nullable=True),
    sa.Column('user_id', models.types.StringUUID(), nullable=False),
    ...
    sa.Column('credential_type', sa.String(length=32), server_default=sa.text("'api-key'"), nullable=False),
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP(0)'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP(0)'), nullable=False),
    sa.Column('timeout', sa.Float(), server_default=sa.text('30'), nullable=False),
    sa.Column('sse_read_timeout', sa.Float(), server_default=sa.text('300'), nullable=False),
    ...
    sa.Column('created_by_role', sa.String(length=255), server_default=sa.text("'account'"), nullable=False),
    sa.Column('created_by', models.types.StringUUID(), nullable=False),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    sa.Column('agent_based', sa.Boolean(), server_default=sa.text('0'), nullable=False),
    sa.Column('workflow_run_id', models.types.StringUUID(), nullable=True),
